...
// If http://localhost doesn't work, substitute with your IP address.
...
$cfg->passwordsaltmain = 'supercalafragilisticexpialadoscious';
...
/**
 * Overriding what's in lib/config-defaults.php
 * This is currently set to true on the live box. We don't want duplicate accounts created    .
 */
